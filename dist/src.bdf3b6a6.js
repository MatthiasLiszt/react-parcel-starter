...
function (_React$Component) {
  ...
  function Cup(props) {
    ...
    _this.speed = 1;
    _this.visual = 0;
    _this.oldTime = _this.props.time;
    return _this;
  }
...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.setGameState = function (value) {
      var newState = _this.state;

      if (_this.state.gameState !== 'lost') {
  ...
  _createClass(Game, [{
    ...
    value: function gameFlow() {
      ...
      this.tid = setTimeout(function () {
        console.log('gameState ' + _this2.state.gameState);

        if (_this2.state.gameState === 'running') {
          _this2.gameTime += 0.2;
        ...
        if (_this2.state.gameState === 'lost') {
          _this2.gameMessageColor = 'redMessage';
          _this2.gameMessage = 'GAME OVER';
          _this2.extraButton = 'invisible';
          _this2.interval *= 10000;

          _this2.props.report('lost'); //this.forceUpdate();

        }
      }, this.interval); //return clearTimeout(this.tid);                        
    }
  }, {
    ...
    value: function render() {
      ...
      console.log('cups ' + this.props.settings); //<Cup report={this.props.setGameState} gState={this.state.gameState} index={1} cups={this.props.settings} ></Cup>

      var mydata = _toConsumableArray(Array(this.props.settings));
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_Cup.default, {
          key: i + 1,
          report: _this3.setGameState,
          time: _this3.gameTime
        });
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.onSettingsSet = function (cups) {
    ...
    _this.onSkipDescription = function () {
      var oldState = _this.state;
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      if (this.restart) {
        ...
        return _react.default.createElement("div", null, "...restart");
      }
      ...
      if (!this.state.showDescription && !this.state.settingsMenu) {
        return _react.default.createElement("div", null, _react.default.createElement("div", {
          ...
          settings: this.state.cups,
          report: this.setGameState
        })), _react.default.createElement("div", {
          className: "centered"
...
var _default = App;
exports.default = _default;
},{"react":"n8MK","./Settings.jsx":"GT9S","./Description.jsx":"AOuA","./Game.jsx":"zHwg"}],"Q40o":[function(require,module,exports) {
'use strict';
...
//# sourceMappingURL=/src.bdf3b6a6.js.map