...
},{"./cjs/react-dom.production.min.js":"i17t"}],"GT9S":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Settings, [{
    key: "updateCups",
    value: function updateCups(n) {
      var check = this.state.cups + n;

      if (check >= 1 && check <= 8) {
        var cups = this.state.cups + n;
        this.setState({
          cups: cups,
          alreadyShown: this.state.alreadyShown
        });
        return;
      }
    }
    ...
    value: function render() {
      ...
      if (!this.props.shown) {
        return _react.default.createElement("div", {
          className: "centered"
        }, _react.default.createElement("h6", null, "Number of cups:"), _react.default.createElement("div", {
          className: "box",
          id: "cups"
        }, this.state.cups), _react.default.createElement("div", null, _react.default.createElement("p", null, _react.default.createElement("button", {
          className: "borderless",
          onClick: function onClick() {
            return _this2.updateCups(1);
          }
        }, "\xA0/\\\xA0")), _react.default.createElement("p", null, _react.default.createElement("button", {
          className: "borderless",
          onClick: function onClick() {
            return _this2.updateCups(-1);
          }
...
},{"react":"n8MK"}],"AOuA":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Description(props) {
    ...
    _this.description = 'The cups will fill from time to time. You can drink them empty by clicking on a cup. Try to drink all cups before they get too full. The speed of the filling process will increase after time.';
    _this.skipMsg = "Don't show this description again.";
    _this.state = {
      skip: _this.shouldBeSkipped(),
      skipcheck: ' '
    };
    return _this;
  }
  ...
  _createClass(Description, [{
    key: "shouldBeSkipped",
    value: function shouldBeSkipped() {
      var check = localStorage.getItem("noCoffeeTranscription");
    ...
    key: "noDescription",
    value: function noDescription() {
      var newState = {
        skip: this.shouldBeSkipped(),
        skipcheck: 'x'
      };
    ...
    key: "skipDescription",
    value: function skipDescription() {
      var newState = {
        skip: true,
        skipcheck: 'x'
      };
    ...
    value: function render() {
      ...
      if (this.props.show && !this.state.skip) {
        return _react.default.createElement("div", {
          className: "centered"
        }, _react.default.createElement("p", null, this.description), _react.default.createElement("p", null, _react.default.createElement("button", {
          className: "white",
          onClick: function onClick() {
            return _this2.noDescription();
          }
        }, this.state.skipcheck), " ", this.skipMsg), _react.default.createElement("p", null, _react.default.createElement("button", {
          className: "finalButton",
          onClick: function onClick() {
            return _this2.skipDescription();
          }
        }, "Start")));
      } else {
        return _react.default.createElement("div", null);
...
exports.default = _default;
},{"react":"n8MK"}],"dBnG":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Cup, [{
    ...
    value: function gameFlow() {
      ...
      if (this.props.gState == 'running') {
        var tid = setTimeout(function () {
          ...
          if (_this2.props.gState == 'running') {
            if (_this2.fullness < 5) {
              _this2.fullness += 0.6 * _this2.speed;
              _this2.visual = Math.floor(_this2.fullness);
              console.log(_this2.fullness + ' ' + _this2.visual); //setTimeout(this.gameFlow,200);
            }
    ...
    value: function render() {
      ...
      if (this.props.index <= this.props.cups) {
        ...
        return _react.default.createElement("div", {
          onClick: function onClick() {
            return _this3.emptyCup();
          }
        }, _react.default.createElement("span", {
          className: 'full' + String(this.visual)
...
var _default = Cup;
exports.default = _default;
},{"react":"n8MK"}],"zHwg":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.state = {
      gameState: 'paused',
      nextGameState: 'Resume'
    };
    _this.gameMessage = 'Game Paused';
    _this.gameMessageColor = 'yellowMessage';
    _this.extraButton = 'finalButton'; //valid gameStates are : running,  paused, lost,restart
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ...
      var tid = setTimeout(function () {
        console.log('gameState ' + _this2.props.getGameState());

        if (_this2.props.getGameState() == 'setup') {
          _this2.setState({
            gameState: 'paused',
            nextGameState: 'Resume'
          });

          _this2.props.setGameState('paused');
        }

        if (_this2.props.getGameState() == 'lost') {
          _this2.setState({
            gameState: 'lost',
            nextGameState: 'Retry'
          });

          _this2.gameMessageColor = 'redMessage';
          _this2.gameMessage = 'GAME OVER';
          _this2.extraButton = 'invisible';

          _this2.forceUpdate();
        }

        if (_this2.state.gameState == 'running' && _this2.props.getGameState() != 'lost') {
          _this2.gameTime += 0.2;
          _this2.gameMessageColor = 'yellowMessage';
        }
      }, 200);
      this.props.pTId(tid); //console.log('cups '+this.props.settings);

      if (this.props.show) {
        return _react.default.createElement("div", {
          className: "centered"
        }, _react.default.createElement("p", {
          className: "cupcentered"
        }, _react.default.createElement("center", null, _react.default.createElement(_Cup.default, {
          report: this.props.setGameState,
          gState: this.state.gameState,
          index: 1,
          cups: this.props.settings,
          pTId: this.props.pTId
        }), _react.default.createElement(_Cup.default, {
          report: this.props.setGameState,
          gState: this.state.gameState,
          index: 2,
          cups: this.props.settings,
          ...
          className: "blueTime"
        }, this.gameTime.toFixed(2), "s"), _react.default.createElement("p", {
          className: this.gameMessageColor
        }, this.gameMessage), _react.default.createElement("p", null, _react.default.createElement("button", {
          onClick: function onClick() {
            return _this2.runOrPauseGame();
          },
          className: this.extraButton
        }, this.state.nextGameState)));
      } else {
        return _react.default.createElement("div", null);
      }
    }
...
var _default = Game;
exports.default = _default;
},{"react":"n8MK","./Cup.jsx":"dBnG"}],"DPRK":[function(require,module,exports) {
"use strict";
...
var _Settings = _interopRequireDefault(require("./Settings.jsx"));

var _Description = _interopRequireDefault(require("./Description.jsx"));

var _Game = _interopRequireDefault(require("./Game.jsx"));
...
var pushtId = function pushtId(id) {
  timeOutIds.push(id);
};
...
var SetGameState = function SetGameState(x) {
  gameState.game = x;
};
...
function (_React$Component) {
  ...
  _createClass(App, [{
    key: "onSettingsSet",
    value: function onSettingsSet(cups) {
      gameState.settingsShown = true;
      gameState.cups = cups;
      console.log(JSON.stringify(gameState));
    }
  }, {
    key: "onSkipDescription",
    value: function onSkipDescription() {
    ...
    key: "setGameState",
    value: function setGameState(value) {
      gameState.game = value;
    }
  }, {
    key: "bangAllTimeouts",
    value: function bangAllTimeouts() {
      console.log('trying to cancel all timeouts ');
      timeOutIds.map(function (id) {
        clearTimeout(id);
      });
      timeOutIds.map(function () {
        timeOutIds.pop();
      });
    }
  }, {
    key: "checkForGameStart",
    value: function checkForGameStart() {
      if (gameState.settingsShown && !gameState.showDescription) {
        return true;
      } else {
        return false;
      }
    ...
    value: function changeSettings() {
      console.log('trying to change settings'); //alert('settings');
      ...
      gameState.game = 'setup';
      this.gameEnd = 'invisible';
      this.restart = undefined; //this.restart=!this.restart;
    ...
    value: function render() {
      ...
      var checkUntilGameStart = function checkUntilGameStart() {
        gameState.startGame = _this2.checkForGameStart();

        _this2.checkForGameEnd();

        _this2.forceUpdate();
      };

      setTimeout(function () {
        return checkUntilGameStart();
      }, 1500);

      if (!this.restart) {
        return _react.default.createElement("div", {
          refresh: String(this.restart)
        }, _react.default.createElement("div", {
          className: "mainline"
        }, _react.default.createElement("span", null, "Coffee Game"), _react.default.createElement("div", {
          id: "logo"
        })), _react.default.createElement("div", null, _react.default.createElement(_Settings.default, {
          onSettingsSet: this.onSettingsSet,
          shown: gameState.settingsShown
        })), _react.default.createElement("div", null, _react.default.createElement(_Description.default, {
          onSkipDescription: this.onSkipDescription,
          show: gameState.settingsShown
        })), _react.default.createElement("div", null, _react.default.createElement(_Game.default, {
          show: gameState.startGame,
          settings: gameState.cups,
          ...
          onClick: function onClick() {
            return _this2.retryGame();
          },
          className: this.gameEnd
        }, "Retry")), _react.default.createElement("p", null, _react.default.createElement("button", {
          onClick: function onClick() {
      ...
      if (this.restart) {
        ...
        return _react.default.createElement("div", {
          ...
          id: "logo"
        }), _react.default.createElement("sup", null, "restarted")), _react.default.createElement("div", null, _react.default.createElement(_Game.default, {
          show: gameState.startGame,
          settings: gameState.cups,
          setGameState: SetGameState,
          getGameState: GetGameState,
...
var _default = App;
exports.default = _default;
},{"react":"n8MK","./Settings.jsx":"GT9S","./Description.jsx":"AOuA","./Game.jsx":"zHwg","./Cup.jsx":"dBnG"}],"Q40o":[function(require,module,exports) {
'use strict';
...
},{"./factoryWithThrowingShims":"wVGV"}],"ElIr":[function(require,module,exports) {
'use strict';
...
var _default = styled;
exports.default = _default;
},{"fbjs/lib/hyphenateStyleName":"R6xY","react":"n8MK","stylis":"YOxv","stylis-rule-sheet":"UYYs","prop-types":"D9Od","hoist-non-react-statics":"ElIr","react-is":"H1RQ","process":"pBGv"}],"deHo":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK","react-dom":"NKHc","./App.jsx":"DPRK","styled-components":"tFSs"}]},{},["deHo"], null)
//# sourceMappingURL=/src.a6c2777e.js.map